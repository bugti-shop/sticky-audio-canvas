    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-8 pb-24">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            The App integrates with third-party services including Firebase, Google Sign-In, RevenueCat, and Mapbox. Your use of these services is subject to their respective terms of service and privacy policies. We are not responsible for the practices or content of third-party services.
          </p>
        </section>
