      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-8 pb-24">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-2">
            ...
            <li>Cloud sync data if you enable real-time synchronization</li>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Your notes, tasks, and personal data are primarily stored locally on your device using secure storage mechanisms. When you enable cloud sync, your data is encrypted during transit and stored securely on Firebase servers.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1 ml-2">
            <li><strong>Firebase:</strong> For real-time cloud synchronization of your data</li>
