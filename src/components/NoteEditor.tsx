...
import { SketchCollabToolbar } from './SketchCollabToolbar';
...
export const NoteEditor = ({ note, isOpen, onClose, onSave, defaultType = 'regular', defaultFolderId, allNotes = [], returnTo }: NoteEditorProps) => {
  ...
  const sketchCollab = useSketchCollaboration();
        ...
        <ErrorBoundary>
          {noteType === 'voice' ? (
            ...
            <div className="flex flex-col h-full relative">
              <SketchCollabToolbar collaboration={sketchCollab} />
              <div className="flex-1 relative">
                <Suspense fallback={<div className="flex-1 flex items-center justify-center h-full bg-background" />}>
                  <SketchEditor
                    ...
                    collabUsers={sketchCollab.isConnected ? sketchCollab.users : undefined}
                    collabRemoteStrokes={sketchCollab.isConnected ? sketchCollab.remoteStrokes : undefined}
                    collabLiveStrokes={sketchCollab.isConnected ? sketchCollab.remoteLiveStrokes : undefined}
                    collabMyUserId={sketchCollab.isConnected ? (sketchCollab.myUserId ?? undefined) : undefined}
                    collabIsConnected={sketchCollab.isConnected}
                    collabMyRole={sketchCollab.isConnected ? sketchCollab.myRole : undefined}
                    onCollabCursorMove={sketchCollab.isConnected ? sketchCollab.sendCursor : undefined}
                    onCollabStrokeComplete={sketchCollab.isConnected ? sketchCollab.sendStroke : undefined}
                    onCollabLiveStroke={sketchCollab.isConnected ? sketchCollab.sendLiveStroke : undefined}
                    onCollabFinishLiveStroke={sketchCollab.isConnected ? sketchCollab.finishLiveStroke : undefined}
                    onCollabDeleteStrokes={sketchCollab.isConnected ? sketchCollab.deleteRemoteStrokes : undefined}
                    onCollabUndoMyStroke={sketchCollab.isConnected ? sketchCollab.undoMyLastStroke : undefined}
                    collabRemoteTextAnnotations={sketchCollab.isConnected ? sketchCollab.remoteTextAnnotations : undefined}
                    collabRemoteWashiTapes={sketchCollab.isConnected ? sketchCollab.remoteWashiTapes : undefined}
                    collabRemoteStickyNotes={sketchCollab.isConnected ? sketchCollab.remoteStickyNotes : undefined}
                    collabRemoteTransforms={sketchCollab.isConnected ? sketchCollab.remoteTransforms : undefined}
                    collabRemoteViewports={sketchCollab.isConnected ? sketchCollab.remoteViewports : undefined}
                    collabRemotePageSwitches={sketchCollab.isConnected ? sketchCollab.remotePageSwitches : undefined}
                    onCollabTextAnnotation={sketchCollab.isConnected ? sketchCollab.sendTextAnnotation : undefined}
                    onCollabWashiTape={sketchCollab.isConnected ? sketchCollab.sendWashiTape : undefined}
                    onCollabStickyNote={sketchCollab.isConnected ? sketchCollab.sendStickyNote : undefined}
                    onCollabTransform={sketchCollab.isConnected ? sketchCollab.sendTransform : undefined}
                    onCollabFinishTransform={sketchCollab.isConnected ? sketchCollab.finishTransform : undefined}
                    onCollabClearLayer={sketchCollab.isConnected ? sketchCollab.sendClearLayer : undefined}
                    onCollabViewport={sketchCollab.isConnected ? sketchCollab.sendViewport : undefined}
                    onCollabPageSwitch={sketchCollab.isConnected ? sketchCollab.sendPageSwitch : undefined}
                    onCollabLayerEvent={sketchCollab.isConnected ? sketchCollab.sendLayerEvent : undefined}
                    collabRemoteImageElements={sketchCollab.isConnected ? sketchCollab.remoteImageElements : undefined}
                    onCollabImageElement={sketchCollab.isConnected ? sketchCollab.sendImageElement : undefined}
                    collabChatMessages={sketchCollab.isConnected ? sketchCollab.chatMessages : undefined}
                    collabChatUnread={sketchCollab.isConnected ? sketchCollab.unreadCount : undefined}
                    onCollabChatSend={sketchCollab.isConnected ? sketchCollab.sendChatMessage : undefined}
                    onCollabChatOpen={sketchCollab.isConnected ? sketchCollab.markChatRead : undefined}
                    collabFollowingUserId={sketchCollab.isConnected ? sketchCollab.followingUserId : undefined}
                    onCollabFollowUser={sketchCollab.isConnected ? sketchCollab.followUser : undefined}
                  />
                </Suspense>
              </div>
            </div>
